...
export const portfolioData: PortfolioItem[] = [
  ...
  },
  {
    ...
    assets: [
      ...
      {
        videoUrl: "https://vimeo.com/1120274958/7a2056b41b?share=copy",
        thumbnailUrl: "",
        aspectRatio: "video",
        subtitle: "Dallas Tournament",
        description: "AC POST partnered with Suite Spot and Nintendo's internal team to create this promotional awareness piece highlighting the benefits of e-sports for students in Dallas.",
        additionalCredits: [
          {
            title: "Post Supervisor",
            name: "Conor O'Donnell"
  ...
  },
  {
    ...
    additionalCredits: [
      {
        title: "Photoshop Layout Designer (Text Graphics)",
        name: "Simin Lim",
        url: "https://www.siminlim.com/"
      }
    ],
    assets: [
  ...
  },
  {
    ...
    assets: [
      ...
      {
        videoUrl: "https://vimeo.com/1118152764/44f6f1ddb3?share=copy",
        thumbnailUrl: "",
        aspectRatio: "video",
        title: "Slack",
        subtitle: "Slack Q2 Hype Video",
        description: "Collaborated with Suite Spot and Slack's internal team to produce a hype video for an all call employees event. This energetic piece was designed to boost morale and excitement among team members, featuring dynamic motion graphics and engaging visual storytelling that captured the collaborative spirit of the company.",
        role: "Motion Graphics · Sound Design & Mix · Color",
        additionalCredits: [
          {
            title: "Post Supervisor",
  ...
  },
  {
    ...
    description: [
      "AC POST, in partnership with the Love Serve Remember Foundation, produced an Unreal Engine–driven animated short based on a Ram Dass lecture. The film translates his 'woods' metaphor—seeing trees without judgment—into a visual essay on human uniqueness and acceptance. AC POST handled end-to-end post: real-time lookdev, layout, lighting, and rendering in Unreal; editorial integration; and color to deliver a calm, meditative piece anchored by the original narration.",
